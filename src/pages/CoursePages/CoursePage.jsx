    ...
    <div className={styles.course}>
        ...
        <div className={styles.inp_price_categ}>
            <div className={styles.search_teg}>
                ...
                <input className={styles.inp_teg} type="text" placeholder='введите название..'/>
            </div>
            <div className={styles.price_teg}>
                <div className={styles.price}>Цена</div>
                <hr className={styles.siz} />от
                <input className={styles.inp_price}
                    type="number" step="0.01" min="0" placeholder="0,00"/>до
                    <input className={styles.inp_price}
        ...
        <div className={styles.card_smm_cours}>
            ...
            <div className={styles.list_smm}>
                ...
                <div className={styles.p_text}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum volutpat orci turpis urna. Et vestibulum, posuere tortor lacinia sit. Sagittis porttitor orci auctor in at tincidunt arcu egestas.</div>
                ...
                <div className={styles.but_info}>
                    <button className={styles.p_info}>Подробнее</button>
                </div>
            </div>
        </div>
